...
use crate::view::ui::view_pipeline::{should_show_line_number, LineStart, ViewLine, ViewLineIterator};
...
impl SplitRenderer {
    ...
    pub fn render_content(
        ...
        split_view_states: Option<&HashMap<crate::model::event::SplitId, crate::view::split::SplitViewState>>,
        hide_cursor: bool,
        ...
        for token in tokens {
            match &token.kind {
                ...
                ViewTokenWireKind::Text(text) => {
                    ...
                    if text_len > available_width && !crate::primitives::ansi::contains_ansi_codes(text) {
